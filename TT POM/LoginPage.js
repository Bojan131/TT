...
class LoginPage{
    ...
    await expect(page.locator(".message span").first()).toHaveText("Benutzername oder Passwort ist falsch");
    await expect(page.locator(".message span").last()).toHaveText("Bitte versuchen Sie es nochmals.");
    }
