...
class MONEY_MARKETS{
    ...
    async moneyMarketsOverview(){
        ...
        const expectedTexts = [
            "Interest market overview", "Key interest rates", "Interbank interest rates", "SOFR USD"
          ];
    ...
    async inflation(){
        ...
        const expectedTexts1 = [
            "Inflation YOY", "Inflation Historical"
          ];
          await this.base.checkItems(this.inflationTableName,expectedTexts1);
          const expectedTexts2 = [
            "Austria", "European Union","Germany","Russian Federation","Switzerland","United Kingdom","United States of America"
          ];
    ...
    async checkboxes(){
        ...
        const expectedTexts2 = [
            "Austria", "European Union","Germany","Russian Federation","Switzerland","United Kingdom","Japan"
          ];
          await this.base.checkItems(this.highChartCountries,expectedTexts2);
    }
